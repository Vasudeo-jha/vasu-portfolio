...
import dubaiCharityImage from '@/assets/projectImg/dubaiCharity.png'
...
export const experienceData = [
  {
    ...
    description:
      "Led the frontend development team, architected scalable React applications, and implemented modern UI/UX patterns. Improved application performance by 40% through code optimization and lazy loading strategies.",
  ...
  },
  {
    ...
    description:
      "Developed responsive web applications for various clients using React and Next.js. Collaborated with designers to implement pixel-perfect UIs and ensured cross-browser compatibility.",
  ...
  },
  {
    ...
    description:
      "Worked with multiple clients to build custom websites and web applications. Specialized in e-commerce solutions and content management systems.",
...
export const projectsData = [
  {
    ...
    slug: "portfolio-cms",
    description:
      "A dynamic portfolio management system built with Next.js and PostgreSQL. Features include admin dashboard, content management, and beautiful glassmorphism UI.",
    imageUrl: "/images/projects/portfolio-cms.jpg",
    liveUrl: "https://portfolio.example.com",
    githubUrl: "https://github.com/Vasudeo-jha/vasu-portfolio",
  ...
  },
  {
    ...
    slug: "dubai-charity",
    description:
      "E-commerce platform for small businesses with inventory management, order tracking, and payment integration. Built for scalability and ease of use.",
    imageUrl: dubaiCharityImage,
    liveUrl: "https://dev-front.dubaicharity.org/",
    githubUrl: "https://github.com/username/dubai-charity",
  ...
  },
  {
    ...
    slug: "hrms-system",
    description:
      "Complete Human Resource Management System with employee management, attendance tracking, leave management, and payroll processing.",
  ...
  },
  {
    ...
    slug: "blog-cms",
    description:
      "Modern blogging platform with markdown support, categories, tags, and SEO optimization. Perfect for content creators and businesses.",
  ...
  },
  {
    ...
    description:
      "Feature-rich admin dashboard template with charts, tables, forms, and authentication. Built with modern design principles.",
...
export const socialLinksData = [
  {
    platform: "GitHub",
    url: "https://github.com/Vasudeo-jha",
    iconName: "Github",
  },
  {
    platform: "LinkedIn",
    url: "https://www.linkedin.com/in/vasu-deo-jha/",
    iconName: "Linkedin",
  },
  { platform: "Twitter", url: "https://x.com/JhaVasudeo", iconName: "Twitter" },
  {
    platform: "Email",
    url: "mailto:vasudeojha503@gmail.com",
    iconName: "Mail",
  },
];
